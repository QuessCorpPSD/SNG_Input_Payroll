...
export class CompanyeditComponent {
  ...
  constructor(private fb: FormBuilder, private dialogRef: MatDialogRef<CompanyeditComponent>, private dialog: MatDialog, private company: CompanyserviceService) { }
  ...
  BindGetEntityName() {
    this.company.getCompanyName().subscribe({
      next: res => { this.entityName = res.Data.data?.getEntityName }
    });
  }
  ...
  Save() {
    ...
    console.log("Form submitted", this.CompanyAddForm.value);
  }
