...
@Component({
  ...
  standalone: true,
  imports: [CompanyComponent, PonumbersearchComponent, MatIconModule, CommonModule, FormsModule, AlertpopupComponent, MatPaginatorModule, MatCheckbox, PotypeComponent, POStatusComponent],
...
export class POApproveComponent {
  ...
  potypeEvent(event: any) {
    this.PricingType = event.pricingtype_Id;
  }
