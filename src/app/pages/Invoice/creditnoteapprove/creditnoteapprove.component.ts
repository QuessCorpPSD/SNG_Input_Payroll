...
@Component({
  ...
  imports: [CommonModule,
    ...
    CompanyComponent,
    MatTooltipModule],
  templateUrl: './creditnoteapprove.component.html',
  styleUrl: './creditnoteapprove.component.css'
})
export class CreditnoteapproveComponent {
  ...
  DownloadTemplate() {
    ...
    XLSX.writeFile(wb, 'CreditNoteApprove_Template.xlsx');
  }
