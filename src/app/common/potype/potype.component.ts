...
export class PotypeComponent {
  ...
  ponumber: Company[] = [{"company_Id":1,"companyName":"REGULAR","companyCode":"","displayName":"Regular", "invoice_Billing_Type" : 0},{"company_Id":4,"companyName":"THIRDPARTY","companyCode":"THIRDPARTY","displayName":"ThirdParty", "invoice_Billing_Type": 0}];
  //$!: Observable<Company[]>; 
